...
const BASE_CACHE_FILES = [
  ...
  '/css/index.css', '/archive/index.html', '/about/index.html', '/index.html',
  '/favicon.ico', '/fonts/roboto/Roboto-Regular.woff',
  '/fonts/roboto/Roboto-Regular.woff2', '/svg/icon.svg'
];
...
const NOT_FOUND_CACHE_FILES = [
  '/js/index.js', '/js/canvas.js', '/js/polyfill.js', '/js/av-min.js',
  '/css/index.css', '/404.html', '/favicon.ico',
  '/fonts/roboto/Roboto-Regular.woff', '/fonts/roboto/Roboto-Regular.woff2',
  '/svg/icon.svg'
];
...
const CACHE_BLACKLIST = [
  ...
  //    !str.startsWith('https://gohugohq.com');
  //},
];
...
function isBlacklisted(url) {
  return (CACHE_BLACKLIST.length > 0) ? !CACHE_BLACKLIST
                                             .filter((rule) => {
    ...
    return cache.match(event.request)
        .then((response) => {
          ...
          if (response) {
            ...
            if (date) {
              let age =
                  parseInt((new Date().getTime() - date.getTime()) / 1000);
                ...
                return new Promise((resolve) => {
                         ...
                         return fetch(event.request.clone())
                             .then((updatedResponse) => {
                               if (updatedResponse) {
                                 cache.put(
                                     event.request, updatedResponse.clone());
